...
.brand { font-weight: 700; color: #0d9488; }
.header-right { display: flex; gap: 12px; align-items: center; }
.greeting { font-weight: 600; }
.date { color: #6b7280; font-size: 0.95rem; }
...
.label { color: #374151; font-weight: 600; min-width: 64px; }
...
.dates-row .value { font-weight: 600; }
.dates-row .separator { color: #6b7280; margin: 0 6px; }
...
.stat-number { font-size: 1.25rem; font-weight: 700; color: #1f2937; }
.stat-label { font-size: 0.9rem; color: #6b7280; }

@media print {
    .summary-card { box-shadow: none; border: 1px solid #000; }
    .chip { background: #eee !important; border-color: #000; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
}
</style>